...
notifications_raw2 = \
[{'id': 36, 'user_id': 2, 'notification': '{"created": "2023-09-16 06:03", "expiration": "2023-12-30 23:59", "interval": "60", "persistence": "YES", "notificationCores": [{"notificationCore0": {"pv0": "TS-04:PU-InjSeptG-1:Voltage-Mon", "rule0": "pv < L", "limit0": "812.6", "subrule0": "OR"}}, {"notificationCore1": {"pv1": "TS-04:PU-InjSeptG-2:Voltage-Mon", "rule1": "(pv > LL) and (pv < LU)", "limitLL1": "-5", "limitLU1": "810.8", "subrule1": ""}}]}', 'sms_text': "TS's Septa Problem!", 'last_sent': None},
 {'id': 39, 'user_id': 2, 'notification': '{"created": "2023-09-21 03:03", "expiration": "2024-12-30 23:59", "interval": "60", "persistence": "YES", "notificationCores": [{"notificationCore0": {"pv0": "SI-.+C4:DI-DCCT:Current-Mon", "rule0": "(pv < LL) and (pv > LU)", "limitLL0": "0", "limitLU0": "200", "subrule0": ""}}]}', 'sms_text': "Machine Current is Low!", 'last_sent': None}]
